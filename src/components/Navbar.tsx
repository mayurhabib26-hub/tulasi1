            ...
            <div className="relative">
              <form onSubmit={handleSearchSubmit} className="relative flex items-center">
                <div
                  className={`flex items-center bg-[#FFF2F8] border rounded-full transition-all duration-300 ${
                    isSearchExpanded
                      ? 'w-64 sm:w-80 border-[#F50087] ring-2 ring-pink-200'
                      : 'w-10 sm:w-56 lg:w-64 border-pink-200 focus-within:border-[#F50087]'
                  }`}
                >
                  <button
                    type="submit"
                  ...
                  <input
                    ...
                    className={`bg-transparent text-xs sm:text-sm text-[#191919] placeholder-neutral-400 focus:outline-none pr-3 py-2 w-full ${
              ...
              {searchQuery.trim() !== '' && (
                <div
                  ...
                  className="absolute right-0 mt-2 w-72 sm:w-96 bg-white rounded-2xl shadow-2xl border border-pink-100 p-3 z-50 animate-fadeIn"
                >
